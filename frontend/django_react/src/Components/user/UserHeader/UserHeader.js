    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-dark">
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          {/* <!-- Navbar brand --> */}
          <Link className="navbar-brand mt-2 mt-lg-0" to='/' style={{ color: 'white' }}>
            COSMOS
          </Link>
        ...
        {/* //  <!-- Left links --> */}
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            {authentication_user.isAuthenticated?<Link className="nav-link" to='/profile' style={{ color: 'white' }}>{authentication_user.name}</Link>: <Link className="nav-link" to='/login' style={{ color: 'white' }}>Login</Link>}
